...
I’m an AI and Design Thinking student in the 11th grade, passionate about turning ideas into carefully crafted digital experiences. Technology and electronics have always been part of my life — with both my father and grandfather working in tech, I grew up surrounded by computers, PCBs, and systems long before I fully understood them. My first real exposure to programming came early, when my dad taught me C and C++ at the age of 8, and that curiosity quickly turned into a long-term obsession with understanding how things work from the ground up. Today, I care deeply about UI/UX, systems design, and building products that don’t just function, but feel intentional, polished, and memorable. I’m also consistently sharpening my problem-solving and algorithmic thinking, especially through competitive programming and LeetCode.

I’m interested in a lot of things, and I see that as creative fuel rather than distraction. I’m a competitive FPS and roguelike gamer, drawn to mechanically demanding games and deep systems that reward mastery, optimization, and iteration — from thousands of hours in Counter-Strike and Rainbow Six to build-focused roguelikes and challenging platformers. I explore web development, game development, hardware tinkering, PCB work, and PC modding, and I have a strong passion for Linux — from early exposure to Ubuntu and Fedora to daily-driving Arch Linux, where I’ve spent years ricing, configuring, breaking, and rebuilding my system through dotfiles, window managers, and custom workflows. I’m unapologetically docs-first, learn heavily through trial and error, and tend to obsess over details and polish. Beyond tech, I’m into car modding, archery, music, and anime/manga/manhwa, all of which shape how I think, design, and solve problems. Everything I build reflects that mix of curiosity, systems thinking, and a relentless drive to understand things deeply.
